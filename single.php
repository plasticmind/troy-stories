...
?>
    ...
    <footer class="story-footer">
        ...
        <aside class="share">
            ...
            <a class="icon-facebook" rel="nofollow" href="https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>"
            ...
            <a class="icon-twitter" rel="nofollow" href="https://twitter.com/share?text=<?php echo esc_attr(get_the_title()); ?>&amp;url=<?php the_permalink(); ?>"
