...
<div class="site-footer">
  <div class="logo">
    ...
    <a href="<?php echo bloginfo( 'url' ); ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/i/logo-light.png" alt="Troy Stories Logo" srcset="<?php echo get_stylesheet_directory_uri(); ?>/assets/i/logo-light.svg" /></a>
  </div>
  <div class="social">
    <ul>
